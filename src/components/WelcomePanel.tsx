...
function WelcomePanel(props:propType) {
  ...
  return (
    <div id={props.id} className=' flex flex-col lg:flex-row lg:items-center lg:justify-center lg:gap-6 bg-ui-back-space-blue w-full h-screen'>
      <img className=' mt-5 lg:mt-0 self-center object-contain h-2/3 max-w-[80%]' src={mainGraphic} alt="Main Graphic"></img>
